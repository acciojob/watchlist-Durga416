...
public class MovieRepository {
    ...
    private HashMap<String, Movie> movieMap;    //movie hashmap will store movie_name,movie_object
    private HashMap<String, Director> directorMap;  //director_name, director_object
    private HashMap<String, List<String>> directorMovieMapping; //director_name, list of all movies directed by that director
